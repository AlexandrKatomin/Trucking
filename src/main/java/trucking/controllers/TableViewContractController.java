...
public class TableViewContractController{
    @FXML    TableView<Contract> tableViewContract;

    @FXML    TableColumn<Contract,String> columnNumber;

    @FXML TableColumn<Contract,Date> columnDate;

    @FXML TableColumn<Contract,Double> columnPrice;

    @FXML TableColumn<Contract,Double> columnCargo;

    @FXML TableColumn<Contract,Driver> columnDriver;

    @FXML TableColumn<Contract,String> columnCar;

    @FXML TableColumn<Contract,Boolean> columnOurCar;

    @FXML TableColumn<Contract,Company> columnCompany;
    ...
    public void initialize() {
        ...
        ObservableList<Contract> listCar = FXCollections.observableList(contractService.getAll());
        tableViewContract.setItems(listCar);
